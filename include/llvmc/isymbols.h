...
namespace llvmc {
    ...
    namespace symbols {
        ...
        class Env {
            ...
            std::unordered_map<std::string_view, std::shared_ptr<inter::Id>> table_;
        ...
        public:
            ...
            std::shared_ptr<inter::Id> get_current(std::string_view);
            std::shared_ptr<inter::Id> get(std::string_view);
